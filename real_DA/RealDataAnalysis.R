...
for (i in 1:2) {
    ...
    for (model_name in names(model_list)) {
        ...
        for (i in 1:N_sim) {
            ...
            fit <- eic(Z = Z., y = y., n = n., p = p, scale.Z = FALSE, scale.y = FALSE, step = 100, K = 5, mu = 10, earlyStopping_max = 15, Sig_B = Sig_B, etol = 1e-4, noise = "additive", penalty = "lasso", proj = proj, constrain = constrain)
